...
import mineconstruc.com.exercicio2googlemaps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double lat = i.getExtras().getDouble("latitude");
        double lon = i.getExtras().getDouble("longitude");
